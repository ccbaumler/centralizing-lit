...
<div class="col">
  <svg width="500" height="175">
    <a href="https://play.google.com/store/apps/details?id=com.innologica.inoreader&pcampaignid=web_share" target="_blank">
      <rect x="10" y="10" width="480" height="160" rx="10" ry="10" fill="blue" />
...
<div class="col">
  <svg width="500" height="175">
    <a href="https://apps.apple.com/us/app/inoreader-news-rss-reader/id892355414" target="_blank">
      <rect x="10" y="10" width="480" height="160" rx="10" ry="10" fill="red" />
...
-   Journal options
    ...
    -   [The NIH Library](https://www.nihlibrary.nih.gov/){target="_blank"} + click `Journals`
...
::: {.column width="65%" .absolute top=100 right=0}
```{mermaid}
%%| echo: false
%%| mermaid-format: png
